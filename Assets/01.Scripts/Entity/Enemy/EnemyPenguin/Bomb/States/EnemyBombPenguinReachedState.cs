...
public class EnemyBombPenguinReachedState : EnemyBaseState
{

    public EnemyBombPenguinReachedState(Enemy enemy, EnemyStateMachine stateMachine, string animBoolName) : base(enemy, stateMachine, animBoolName)
    {
    }
