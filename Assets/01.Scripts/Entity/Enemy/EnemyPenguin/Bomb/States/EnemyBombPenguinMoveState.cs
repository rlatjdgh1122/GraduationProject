...
public class EnemyBombPenguinMoveState : EnemyBaseState
{
    public EnemyBombPenguinMoveState(Enemy enemy, EnemyStateMachine stateMachine, string animBoolName) : base(enemy, stateMachine, animBoolName)
    {
    }
